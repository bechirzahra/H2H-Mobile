...
import com.example.selim.h2h.adapter.NavigationDrawerAdapter;
import com.example.selim.h2h.model.NavDrawerItem;
...
public class FragmentDrawer extends Fragment {
    ...
    public static List<NavDrawerItem> getData() {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            navItem.setImg(navMenuIcons.getResourceId(i, -1));
            data.add(navItem);
        }
        return data;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(ParseUser.getCurrentUser().get("Type").equals("Doctor")) {
            ...
            titles = getActivity().getResources().getStringArray(R.array.nav_drawer_labels_patient);
            navMenuIcons = getActivity().getResources().obtainTypedArray(R.array.nav_drawer_icons);
        }
    }
